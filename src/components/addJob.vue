<template>
    <main id="add_job" class="main-container">
        <div class="toast-message" v-if="job_added">
			...
			<div class="container">
				<div class="add-form row">
					...
					<div class="col-md-6 col-xs-12 add-form__container">
						...
						<div class="form-item">
							<div class="form-item__input form-group">
								<label for="vacancy_description">Description *</label>
                        ...
                        <div class="form-submit">
                            <button class="btn btn-primary" @click.prevent="addJob">ADD VACANCY</button>
                        </div>
					</div>
				</div>
			</div>
	...
	methods: {
		addJob() {
            ...
            if(!this.errors.any()) {
                ...
                this.$http.post('https://job-vacancy-demo.firebaseio.com/jobs.json', this.job).then((data) => {
                    this.resetForm();
                    this.job_added = true;
